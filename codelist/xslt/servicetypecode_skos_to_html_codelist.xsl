...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
		   ...
		   <body><a name="top"></a><h1>ISO 19115-3 Codelist Report</h1>
		      ...
		      <table>
		         <tr>
		            <b>
		               <td>Scope</td></b>
		            <td> Codelist applied to the srv:serviceType element by the GA Profile </td>
		         </tr>
		         <tr>
		            <b>
		      ...
		      <h2> gapSV_ServiceTypeCode ( gapSV_ServiceTypeCode ): </h2>
		      <b>Description: </b> a service type name
    ...
    <xsl:template match="sp:result">
        ...
        <tr>
            <td valign="top"> <xsl:value-of select="$serviceTypeName"/> </td>
