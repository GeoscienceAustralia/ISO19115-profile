...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/sp:sparql">
		...
		<html lang="en">
		   ...
		   <head>
		      ...
		      <title> Geoscience Australia profile of the ISO 19115-1:2014 DS_AssociationTypeCode codelist </title>
		   </head>
		   <body><a name="top"></a><h1>ISO 19115-3 Codelist Report</h1>
		      <h2> Geoscience Australia profile of the ISO 19115-1:2014 DS_AssociationTypeCode codelist </h2>
		      <table>
		         <tr>
		            <b>
		               <td>Scope</td></b>
		            <td> GA Profile extension of the DS_AssociationTypeCode codelist </td>
		         </tr>
		         <tr>
		            <b>
		      ...
		      <h2> gapDS_AssociationTypeCode ( gapDS_AssociationTypeCode ): </h2>
		      <b>Description: </b> justification for the correlation of two resources
    ...
    <xsl:template match="sp:result">
        ...
        <xsl:variable name="assocTypeName">gapDS_AssociationTypeCode_<xsl:call-template name="substring-after-last">
                <xsl:with-param name="string" select="normalize-space(.//sp:binding[@name='associationType']/sp:uri)"/>
                <xsl:with-param name="char" select="'/'"/>
            </xsl:call-template>            
        </xsl:variable>
        
        <tr>
            <td valign="top"> <xsl:value-of select="$assocTypeName"/> </td>
