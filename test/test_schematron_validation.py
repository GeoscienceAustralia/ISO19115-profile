...
class SchematronValidationTestCase(unittest.TestCase):
    ...
    def test_metadataIdentifier_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.1_metadataIdentifier_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_parentMetadata_pass_2(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.2_parentMetadata_pass2.xml'), 'r', encoding="utf-8")
    ...
    def test_parentMetadata_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.2_parentMetadata_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_parentMetadata_identifier_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.3_parentMetadata_identifier_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_identifier_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.4_resource_identifier_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_constraint_reference_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.5_constraint_reference_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_metadata_security_constraint_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.6_metadata_security_constraint_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_pointofcontact_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.7_resource_pointofcontact_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_maintenance_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.8_resource_maintenance_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_maintenance_update_frequency_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.9_resource_maintenance_update_frequency_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_constraint_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.10_resource_constraint_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_legal_access_constraint_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.11_resource_legal_access_constraint_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_legal_use_constraint_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.12_resource_legal_use_constraint_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_topic_category_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.13_topic_category_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_extent_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.14_extent_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_reference_system_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.15_reference_system_info_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_descriptive_keywords_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.16_descriptive_keywords_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_lineage_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.17_resource_lineage_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_lineage_statement_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.18_resource_lineage_statement_fail.xml'), 'r', encoding="utf-8")
    ...
    def test_resource_and_distribution_format_pass(self):
        ...
        self.assertFalse(fail_assert_exist(results[1], 'rule.ga.mri.resourceanddistributionformat'),
                         msg='schematron 2.7.19 resource format rule and schematron 2.7.20 distribution format rules did did not pass when validating a record with a resource format element and distribution format element.')
    ...
    def test_resource_and_distribution_format_fail(self):
        ...
        # Open files
        rules = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'schematron-rules-ga.sch'), 'r', encoding="utf-8")
        xml = open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'test_data', 'rule_2.7.19_resource_format_and_rule_2.7.20_distribution_format_fail.xml'), 'r', encoding="utf-8")
        
        results = schematron_validator(rules, xml)
        
        self.assertTrue(fail_assert_exist(results[1], 'rule.ga.mri.resourceanddistributionformat'),
                         msg='schematron 2.7.19 resource format rule and schematron 2.7.20 distribution format rules did did not fail when validating a record with out a resource format element or distribution format element.')
