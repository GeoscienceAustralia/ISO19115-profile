...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/sp:sparql">
        ...
        <cat:CT_CodelistCatalogue xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
           ...
           <!-- GA_ProtocolType  -->
           <cat:codelistItem>
              <cat:CT_Codelist id="GA_ProtocolType">
                 <cat:identifier>
                    <gco:ScopedName>GA_ProtocolType</gco:ScopedName>
                 </cat:identifier>
                 <cat:name>
                    <gco:ScopedName>GA_ProtocolType</gco:ScopedName>
                 </cat:name>
    ...
    <xsl:template match="sp:result">
        ...
        <xsl:variable name="protocolTypeName">GA_ProtocolType_<xsl:call-template name="substring-after-last">
        ...
        <cat:codeEntry xmlns:cat="http://standards.iso.org/iso/19115/-3/cat/1.0"
            ...
            <cat:CT_CodelistValue id="{$protocolTypeName}">
                <cat:identifier>
                    <gco:ScopedName><xsl:value-of select="$protocolTypeName"/></gco:ScopedName>
                </cat:identifier>
                <cat:definition>
